function [P,FitResults,GOF,LowestError,BestStart,xi,yi]=findpeaksfit(x,y,SlopeThreshold,AmpThreshold,smoothwidth,peakgroup,smoothtype,peakshape,extra,NumTrials,autozero,fixedparameters,plots)
...
%
% PeakGroup - The number of points around the "top part" of the (unsmoothed)
...
if P(1)>0,
    [FitResults,GOF,LowestError,BestStart,xi,yi]=peakfit([x;y],0,0,NumPeaks,peakshape,extra,NumTrials,startvector,autozero,fixedparameters,plots);
else
